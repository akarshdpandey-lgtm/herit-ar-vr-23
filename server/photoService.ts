...
const VERIFIED_FALLBACK_PHOTOS: Record<string, PhotoItem[]> = {
  'taj-mahal': [
    ...
    {
      id: 'wm-mehtab-1',
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Mehtab_Bagh_Taj_Mahal_view.jpg/1280px-Mehtab_Bagh_Taj_Mahal_view.jpg',
      thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Mehtab_Bagh_Taj_Mahal_view.jpg/400px-Mehtab_Bagh_Taj_Mahal_view.jpg',
      title: 'Mehtab Bagh Taj Mahal view from the opposite bank',
      author: 'Wikimedia Commons Contributor',
      license: 'CC BY-SA 4.0',
      licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
      source: 'Wikimedia Commons',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Mehtab_Bagh_Taj_Mahal_view.jpg',
    },
    {
      id: 'wm-baby-taj-1',
